...
public interface CompassGpsInterfaceDevice extends CompassGps {
     ...
     * the index operation.
     */
    // (AGR_OSEM) ... ResourceMapping getMappingForEntityForIndex(String name) throws CompassException;

    /**
     * Returns the mapping for the given class name when performing the index operation.
     */
    // (AGR_OSEM) ... ResourceMapping getMappingForEntityForIndex(Class clazz) throws CompassException;
