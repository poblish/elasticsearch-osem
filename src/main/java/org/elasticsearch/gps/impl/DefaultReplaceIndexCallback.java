 ...
 * @author kimchy
 */
public class DefaultReplaceIndexCallback // (AGR_OSEM) ... implements SearchEngineIndexManager.ReplaceIndexCallback, SearchEngineIndexManager.IndexOperationPlan
{
