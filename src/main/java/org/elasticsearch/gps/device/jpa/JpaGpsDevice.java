...
package org.elasticsearch.gps.device.jpa;
...
import org.elasticsearch.gps.device.jpa.entities.EntityInformation;
import org.elasticsearch.gps.device.jpa.entities.JpaEntitiesLocator;
import org.elasticsearch.gps.device.jpa.entities.JpaEntitiesLocatorDetector;
import org.elasticsearch.gps.device.jpa.extractor.NativeJpaExtractor;
import org.elasticsearch.gps.device.jpa.extractor.NativeJpaHelper;
import org.elasticsearch.gps.device.jpa.indexer.JpaIndexEntitiesIndexer;
import org.elasticsearch.gps.device.jpa.indexer.JpaIndexEntitiesIndexerDetector;
import org.elasticsearch.gps.device.jpa.lifecycle.JpaEntityLifecycleInjector;
import org.elasticsearch.gps.device.jpa.lifecycle.JpaEntityLifecycleInjectorDetector;
import org.elasticsearch.gps.device.jpa.queryprovider.DefaultJpaQueryProvider;
import org.elasticsearch.gps.device.jpa.queryprovider.JpaQueryProvider;
import org.elasticsearch.gps.device.support.parallel.AbstractParallelGpsDevice;
import org.elasticsearch.gps.device.support.parallel.IndexEntitiesIndexer;
