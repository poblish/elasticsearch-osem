...
package org.elasticsearch.gps.device.jpa.indexer;
...
import org.elasticsearch.gps.device.jpa.EntityManagerWrapper;
import org.elasticsearch.gps.device.jpa.JpaGpsDevice;
import org.elasticsearch.gps.device.jpa.JpaGpsDeviceException;
import org.elasticsearch.gps.device.jpa.queryprovider.HibernateJpaQueryProvider;
    ...
    public void performIndex(CompassSession session, IndexEntity[] entities) {
        for (IndexEntity indexEntity : entities) {
            ...
            try {
                ...
                if (cursor == null) {
			/* (AGR_OSEM) */ throw new UnsupportedOperationException("Not supported yet");
/* (AGR_OSEM)
