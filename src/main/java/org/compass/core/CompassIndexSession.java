...
public interface CompassIndexSession {
     ...
     */
    // (AGR_OSEM) ... ResourceFactory resourceFactory();
     ...
     */
    // (AGR_OSEM) ... void delete(Resource resource) throws CompassException;
     ...
     * @throws CompassException
     */
    // (AGR_OSEM) ... void delete(CompassQuery query) throws CompassException;
