...
/**
 * Hibernate transaction tests that use session#close instead of session#commit with no explicit
 * usage of CompassTransaction.
 *
 * @author kimchy
 */
public class HibernateJustCloseTransactionTests extends TestCase {
