...
public abstract class AbstractSimpleJpaGpsDeviceTests extends AbstractJpaGpsDeviceTests {
    ...
    protected void setUpCoreCompass(CompassConfiguration conf) {
        // (AGR_OSEM) ... conf.addClass(Simple.class).addClass(SimpleBase.class).addClass(SimpleExtend.class);
    }
    ...
    public void testSimple() throws Exception {
        ...
        CompassHits hits = null;	// (AGR_OSEM) ... sess.find("value1");
    ...
    public void testMirror() throws Exception {
        ...
        // (AGR_OSEM) ... assertEquals(1, sess.find("value4").length());
        // (AGR_OSEM) ... assertEquals(1, sess.find("xx1").length());
        // (AGR_OSEM) ... assertEquals(1, sess.find("xx2").length());
        // (AGR_OSEM) ... assertEquals(1, sess.find("zz1").length());
    ...
    public void testExtend() throws Exception {
        ...
        CompassHits hits = null;	// (AGR_OSEM) ... sess.queryBuilder().queryString("value").toQuery().setSubIndexes(new String[] {"simple1"}).hits();
